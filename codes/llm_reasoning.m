...
fmt = ...
    ...
    " - phi_expr: a safety barrier function expression in MATLAB syntax, using variables e (lateral lane error) and emax (maximum tolerated error)." + ...
    "   phi measures how safe the vehicle is: phi=1 means perfectly centered in lane, phi=0 means at the safety boundary, phi<0 means unsafe." + ...
    "   Required properties: phi(e=0,emax)=1, phi(e=emax,emax)=0, phi(e=-emax,emax)=0, symmetric phi(e)=phi(-e), monotonically decreasing as |e| increases, differentiable." + ...
    "   Examples: ""1-(e/emax)^2"" (quadratic), ""cos(pi*e/(2*emax))"" (cosine), ""1-(e/emax)^4"" (quartic, more forgiving near center)." + ...
    "   If the previous run had high lane error, consider a stricter function (lower exponent like ^2). If the previous run was overly cautious, consider a more relaxed function (higher exponent like ^4 or ^6)." + ...
    " Policy:" + ...
    " - If the user uses vague words (""seems"", ""maybe"", ""not sure"", ""probably""), pick the most likely road class they stated," + ...
    " - Only change e_max with explicit user cues." + ...
    " Valid discrete ranges:" + ...
